...
func (r *sourceValidationKnowledgeRepo) GetVersion(_ context.Context, _, _, versionID string) (*domain.KnowledgeVersion, error) {
	r.versionCalls++
	if version := r.versions[versionID]; version != nil {
		return version, nil
	}
	return nil, domain.ErrNotFound
}
