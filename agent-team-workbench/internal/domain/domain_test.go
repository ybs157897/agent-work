...
func TestRunStateMachine(t *testing.T) {
	cases := []struct {
		...
		{RunQueued, RunReconnecting, true},
		{RunStarting, RunReconnecting, true},
		{RunWaitingApproval, RunReconnecting, true},
		{RunInterrupting, RunReconnecting, true},
		{RunCancelling, RunReconnecting, true},
		{RunSucceeding, RunReconnecting, true},
		{RunReconnecting, RunLost, true},
		{RunReconnecting, RunStarting, true},
		{RunReconnecting, RunRunning, true},
		{RunReconnecting, RunWaitingApproval, true},
		{RunReconnecting, RunSucceeding, true},
		{RunReconnecting, RunSucceeded, true},
